...
public class HeaderFooterWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private SparseArrayCompat<View> mHeaderViews = new SparseArrayCompat<>();//类似map，有点节省最高50%的缓存，key:Integer,values:Objects
    ...
    private void onViewChanged() {
        if (onViewChangedListener != null)
            onViewChangedListener.accept(getHeadersCount(), getFootersCount());
    }

    public void setOnViewChangedListener(@Nullable OnViewChangedListener onViewChangedListener) {
        this.onViewChangedListener = onViewChangedListener;
    }

    public HeaderFooterWrapper(@NonNull RecyclerView.Adapter adapter) {
    ...
    public interface OnViewChangedListener {
        void accept(int headerSize, int footerSize);
    }
}